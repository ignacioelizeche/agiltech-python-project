...
def compress_pdf_base64(pdf_base64: str) -> str:
    ...
    configs = [
        {'optimize_level': 2, 'target_ratio': 0.5},        
        {'optimize_level': 4, 'target_ratio': 0.75},
        {'optimize_level': 4, 'target_ratio': 0.5},       
        {'optimize_level': 6, 'target_ratio': 0.75},
        {'optimize_level': 8, 'target_ratio': 0.5}, 
    ]
